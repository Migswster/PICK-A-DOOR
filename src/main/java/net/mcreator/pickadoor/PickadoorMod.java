package net.mcreator.pickadoor;
...
@Mod("pickadoor")
public class PickadoorMod {
	public static final Logger LOGGER = LogManager.getLogger(PickadoorMod.class);
	public static final String MODID = "pickadoor";

	public PickadoorMod(IEventBus modEventBus) {
