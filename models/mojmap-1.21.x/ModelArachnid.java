...
public class ModelArachnid<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "arachnid"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leg_1 = partdefinition.addOrReplaceChild("leg_1",
				CubeListBuilder.create().texOffs(20, 20)
						.addBox(0.5F, -3.0F, -0.5F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 26)
						.addBox(-2.5F, -3.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition leg_2 = partdefinition.addOrReplaceChild("leg_2",
				CubeListBuilder.create().texOffs(16, 20)
						.addBox(0.5F, -3.0F, -0.5F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 22)
						.addBox(-2.5F, -3.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition leg_3 = partdefinition.addOrReplaceChild("leg_3",
				CubeListBuilder.create().texOffs(32, 24)
						.addBox(-2.5F, -3.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(24, 20)
						.addBox(0.5F, -3.0F, -0.5F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(7.5F, 16.0F, 1.5F));

		PartDefinition leg_4 = partdefinition.addOrReplaceChild("leg_4",
				CubeListBuilder.create().texOffs(24, 32)
						.addBox(-2.5F, -3.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 20)
						.addBox(0.5F, -3.0F, -0.5F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(7.5F, 16.0F, 3.5F));

		PartDefinition leg_5 = partdefinition.addOrReplaceChild("leg_5",
				CubeListBuilder.create().texOffs(4, 20)
						.addBox(-1.5F, -3.0F, -0.5F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(16, 32)
						.addBox(-0.5F, -3.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-7.5F, 16.0F, -3.5F));

		PartDefinition leg_6 = partdefinition.addOrReplaceChild("leg_6",
				CubeListBuilder.create().texOffs(8, 32)
						.addBox(-0.5F, -3.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 20)
						.addBox(-1.5F, -3.0F, -0.5F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-7.5F, 16.0F, -1.5F));

		PartDefinition leg_7 = partdefinition.addOrReplaceChild("leg_7",
				CubeListBuilder.create().texOffs(0, 20)
						.addBox(-1.5F, -3.0F, -0.5F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 32)
						.addBox(-0.5F, -3.0F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-7.5F, 16.0F, 1.5F));

		PartDefinition leg_8 = partdefinition.addOrReplaceChild("leg_8",
				CubeListBuilder.create().texOffs(32, 20)
						.addBox(-0.5F, -3.0F, -1.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(8, 20)
						.addBox(-1.5F, -3.0F, -1.5F, 1.0F, 11.0F, 1.0F, new CubeDeformation(0.0F)),
